...
const FoodCard = ({ food }) => {
  ...
  return (
    <div className="mx-auto my-8 max-w-[350px] space-y-6 rounded-xl bg-white px-4 pb-8 pt-4 font-sans shadow-lg dark:bg-[#18181B] transition duration-300 ease-in-out transform hover:scale-105 hover:border-primary">
      ...
      <div className="mx-auto w-[85%] text-black space-y-2 text-center font-semibold">
